    ...
    return (
      <div className="nutrients-table">
        <table className="table bg-white">
          ...
          <tbody>
            <tr>
              <td className="font-weight-bold">Calories</td>
              <td>{calories}</td>
            </tr>
            <tr>
              <td className="font-weight-bold">Carbohydrates</td>
              <td>{carbohydrates && carbohydrates.toFixed(1)}</td>
            </tr>
            <tr>
              <td className="font-weight-bold">Proteins</td>
              <td>{proteins && proteins.toFixed(1)}</td>
            </tr>
            <tr>
              <td className="font-weight-bold">Fats</td>
