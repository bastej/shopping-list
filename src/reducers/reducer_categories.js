...
import frozen_food from "../images/frozen_food.png";
...
const INITIAL_CATEGORIES = {
  ...
  5: { id: 5, name: "frozen-food", img: frozen_food },
  6: { id: 6, name: "sweets", img: sweets },
  7: { id: 7, name: "chemistry", img: chemistry },
  8: { id: 8, name: "drinks", img: drinks }
};
